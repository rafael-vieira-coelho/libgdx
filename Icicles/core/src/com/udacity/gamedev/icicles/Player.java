...
public class Player {
    ...
    // TODO: Add init() function that moves the character to the bottom center
    //  of the screen
    public void init() {
        position = new Vector2(
                viewport.getWorldWidth() / 2,
                Constants.PLAYER_HEAD_HEIGHT);
    }

    // TODO: Create a render function that accepts a ShapeRenderer and
    ...
    public void render(ShapeRenderer renderer) {
        ...
        renderer.circle(
                ...
                Constants.PLAYER_HEAD_SEGMENTS);

        Vector2 torsoTop = new Vector2(
                position.x,
                position.y - Constants.PLAYER_HEAD_RADIUS);
        Vector2 torsoBottom = new Vector2(torsoTop.x,
                torsoTop.y - 2 * Constants.PLAYER_HEAD_RADIUS);
